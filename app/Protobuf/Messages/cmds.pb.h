...
/* Enum definitions */
typedef enum _BasicCmd_CmdType {
    BasicCmd_CmdType_STOP = 0,
    BasicCmd_CmdType_ARM = 1
} BasicCmd_CmdType;
#define _BasicCmd_CmdType_MIN BasicCmd_CmdType_STOP
#define _BasicCmd_CmdType_MAX BasicCmd_CmdType_ARM
#define _BasicCmd_CmdType_ARRAYSIZE ((BasicCmd_CmdType)(BasicCmd_CmdType_ARM+1))

/* Struct definitions */
typedef struct _BasicCmd {
    BasicCmd_CmdType cmdType;
...
#define BasicCmd_init_default                    {_BasicCmd_CmdType_MIN}
...
#define BasicCmd_init_zero                       {_BasicCmd_CmdType_MIN}
#define DebugCmd_init_zero                       {0}

/* Field tags (for use in manual encoding/decoding) */
#define BasicCmd_cmdType_tag                     1
